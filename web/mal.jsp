<%-- 
    Document   : Admin
    Created on : 2/12/2018, 10:33:03 PM
    Author     : Nicolas
--%>
...
<%
    ...
    Admin usuario = (Admin)sesion.getAttribute("usuario");
    if( usuario == null){
              ...
              <ul>
                <center>
                  ...
                  <li><a href="GestionarProveedores.jsp">Gestionar Proveedores</a></li>
                   <li><a href="ControlVentas.jsp">Control ventas</a></li>
                    <li><a href="ControlGanancias.jsp">Control Ganancias</a></li>
                </center>
                &gt;
              </ul>
            </nav>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-10 offset-lg-1">
            <form class="intro-newslatter"> <input placeholder="Usuario" type="text">
              <input class="last-s" placeholder="Contraseña" type="text"> <button

                class="site-btn">Login</button> </form>
          </div>
        </div>
      </div>
    </section>
